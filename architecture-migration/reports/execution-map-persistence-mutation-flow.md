...
- backend/security/SessionAuthorityService.ts:145 insert auth_sessions
- backend/security/SessionAuthorityService.ts:230 update auth_sessions
- backend/security/SessionAuthorityService.ts:240 update auth_sessions
- backend/security/SessionAuthorityService.ts:252 update auth_sessions
- backend/security/webauthn/WebAuthnChallengeRepository.ts:55 insert webauthn_challenges
- backend/security/webauthn/WebAuthnChallengeRepository.ts:99 update webauthn_challenges
- backend/security/webauthn/WebAuthnChallengeRepository.ts:114 delete webauthn_challenges
- backend/security/webauthn/WebAuthnCredentialRepository.ts:123 insert webauthn_credentials
- backend/security/webauthn/WebAuthnCredentialRepository.ts:161 update webauthn_credentials
- backend/security/webauthn/WebAuthnCredentialRepository.ts:178 update webauthn_credentials
- backend/security/webauthn/WebAuthnCredentialRepository.ts:189 update webauthn_credentials
...
- backend/services/authResolver.ts:203 update users
...
- backend/services/companyIntelligenceStore.ts:40 upsert company_intelligence_signals
- backend/services/companyIntelligenceStore.ts:92 upsert company_intelligence_signals
- backend/services/companyMatchService.ts:290 insert notifications
- backend/services/companyProfileService.ts:1336 insert company_profile_refinements
- backend/services/companyThemeStateService.ts:39 update company_theme_state
- backend/services/companyThemeStateService.ts:75 upsert company_theme_state
- backend/services/companyThemeStateService.ts:135 upsert company_theme_state
- backend/services/companyThemeStateService.ts:158 update company_theme_state
- backend/services/companyTrendRelevanceEngine.ts:204 upsert theme_company_relevance
- backend/services/competitorEnrichmentService.ts:190 upsert competitor_enrichment_cache
- backend/services/confidenceCalibrator.ts:68 insert campaign_confidence_outcomes
- backend/services/confidenceCalibrator.ts:153 upsert campaign_confidence_calibration
- backend/services/configService.ts:453 insert config_change_logs
- backend/services/consumptionAnalyticsService.ts:600 upsert organization_credits
