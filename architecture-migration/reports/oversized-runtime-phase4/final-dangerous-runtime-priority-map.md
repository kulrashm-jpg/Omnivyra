# Final Dangerous Runtime Priority Map

Dangerous oversized runtime regions: 14

Priority is restricted to remaining files with verified code-bearing ownership overlap after string/comment payloads are excluded from semantic ownership classification.
