# Transitive Unsafe Propagation Report

Critical transitive unsafe propagation is contained. Cross-module unsafe propagation remains high-only and visible for the next phase.
