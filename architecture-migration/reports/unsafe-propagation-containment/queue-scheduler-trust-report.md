# Queue Scheduler Trust Report

Queue/scheduler trust boundaries remain PARTIAL. Critical propagation is not present; high-only queue/scheduler propagation remains.
