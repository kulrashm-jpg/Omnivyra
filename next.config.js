...
const nextConfig = {
  ...
  redirects: async () => [
    { source: '/blog', destination: '/content/blog', permanent: true },
    { source: '/blog/:slug', destination: '/content/blog/:slug', permanent: true },
    { source: '/blogs', destination: '/content/blog', permanent: true },
    { source: '/blogs/:slug', destination: '/content/blog/:slug', permanent: true },
    { source: '/company-blog', destination: '/content/blog', permanent: true },
    { source: '/company-blog/:slug', destination: '/content/blog/:slug', permanent: true },
