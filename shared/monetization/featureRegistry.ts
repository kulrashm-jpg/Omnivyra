...
const BASE_FEATURES: MonetizationFeatureRegistryEntry[] = [
  ...
  {
    // Lead-capture intelligence — maps the runDiagnosticPrompt process_types to
    // their catalog action_keys (migration 20260821) so per-post token cost is
    // metered in usage_events instead of rejected as an unknown action.
    feature_key: 'intelligence.lead_qualification',
    category: 'intelligence',
    display_name: 'Lead Qualification',
    display_group: 'Lead Detection',
    display_color: 'bg-amber-500',
    charge_mode: 'fixed_credits',
    pricing_strategy: 'credit_cost_config',
    usage_metering_enabled: true,
    requires_credit_hold: true,
    ...
    visible_to_customer: true,
    internal_only: false,
    process_type_mapping: ['qualifyLead'],
    pricing_keys: {
      action_key: 'lead_qualification',
      credit_cost_config: 'lead_qualification',
      action_pricing_config: 'lead_qualification',
      usage_action_key: 'lead_qualification',
    },
  },
  {
    feature_key: 'intelligence.lead_predictive_scoring',
    category: 'intelligence',
    display_name: 'Predictive Lead Scoring',
    display_group: 'Lead Detection',
    display_color: 'bg-amber-500',
    charge_mode: 'fixed_credits',
    pricing_strategy: 'credit_cost_config',
    ...
    visible_to_customer: true,
    internal_only: false,
    process_type_mapping: ['qualifyPredictiveLead'],
    pricing_keys: {
      action_key: 'lead_predictive_scoring',
      credit_cost_config: 'lead_predictive_scoring',
      action_pricing_config: 'lead_predictive_scoring',
      usage_action_key: 'lead_predictive_scoring',
    },
  },
  {
  ...
  },
  {
    ...
    process_type_mapping: [
      ...
      'suggestDuration',
      'parseRefinedDay',
      'viralityDiagnostic:asset_coverage',
      'viralityDiagnostic:platform_opportunity',
      'viralityDiagnostic:engagement_readiness',
      'viralityComparisons',
      'viralityOverallSummary',
      'qualifyLead',
