...
| **GAP-007** | **High** | The deploy-time schema gate covers 21 tables, **none of them PI**. See §2.4. | VERIFIED |
...
| **POLICY-1** | Unsubscribe scope and anchor: channel-scoped or `*`; person- or target-anchored; revocable | Compliance decision |
