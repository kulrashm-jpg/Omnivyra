/** Part 2/2 of intelligence-control.tsx — verbatim split (barrel preserved; importers unchanged). */
/**
...
import { type Tab, type InsightsData, fmtDate } from './intelligenceControlPanels';
