/**
 * Shared types and pure helper functions for DailyPlanningInterface.
 * No React imports, no external I/O — safe to import from anywhere.
 */
...
export const warnDailyNormalizationIssue = (item: Partial<DailyExecutionItem>, context: string) => {
...
export const computeDefaultExpiryDateLocal = (createdAt?: string | null) => {
...
export const buildRetentionReminderScheduleLocal = (expiresAt?: string | null) => {
...
export const applyDefaultRetentionLocal = (item: DailyExecutionItem): DailyExecutionItem => {
...
export const normalizeManualActivityToDailyItem = (
...
export const normalizeActivityToDailyItem = (
  activity: Partial<DailyActivity>,
  campaignId?: string | null,
  weekNumber?: number
): DailyExecutionItem => {
...
export const normalizeStatusForActivity = (status: unknown): DailyActivity['status'] => {
