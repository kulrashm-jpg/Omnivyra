/** Part 2/2 of BlogEditorForm.tsx — verbatim split (barrel preserved; importers unchanged). */
'use client';
...
import { CATEGORY_OPTIONS, inferCategory, MARKETING_KEYWORD_SUGGESTIONS, type BlogFormState, defaultState, slugFromTitle, type Props, BlockEditor } from './BlogEditorFormModel';
