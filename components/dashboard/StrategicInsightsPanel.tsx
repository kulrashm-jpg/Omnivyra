    ...
    if (sortedInsights.length === 0) {
      return (
        <Card className={className}>
          ...
          <CardContent>
            <EmptyState
              title="Generate your first strategic insight"
              description="This is where the product starts turning raw activity into a clearer story about what to do next."
              primaryAction={{
                label: 'Generate your first insight',
                onClick: () => {
                  trackActivationEvent('empty_state_primary_clicked', {
                    accountId: companyId,
                    context: 'strategic_insights_dashboard',
                  });
                  if (campaignId) {
                    void fetchInsights();
                  }
    ...
    return (
      <Card className={className}>
        ...
        <CardContent>
          <EmptyState
            title="Generate your first strategic insight"
            description="Insights appear when campaign health, engagement, trends, and inbox signals start connecting into one recommendation."
            primaryAction={{
              label: 'Generate your first insight',
              onClick: () => {
                trackActivationEvent('empty_state_primary_clicked', {
                  accountId: companyId,
                  context: 'strategic_insights_campaign',
                });
                void fetchInsights();
              },
            }}
