...
import { Users, CheckCircle, Calendar, UserPlus, Settings } from 'lucide-react';
import { useRouter } from 'next/router';
import { useCompanyContext } from '../CompanyContext';
import SystemStateDashboard from '../analytics/SystemStateDashboard';
...
export function DashboardAnalyticsTab() {
  ...
  return (
    <SystemStateDashboard companyId={selectedCompanyId} variant="embedded" />
  );
}
