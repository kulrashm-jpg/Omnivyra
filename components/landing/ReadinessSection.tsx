...
export default function ReadinessSection() {
  ...
  return (
    <section id="readiness-section" className="bg-white px-4 py-16 sm:px-6 sm:py-20">
      <div className="mx-auto max-w-2xl">
        ...
        {score === null ? (
          <form onSubmit={handleStartAnalysis} className="mt-10 rounded-2xl border border-gray-200 bg-[#F5F9FF] p-6 shadow-omnivyra sm:p-8">
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="campaignBudget" className="block text-sm font-medium text-gray-700">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-8 w-full rounded-omnivyra landing-btn-primary py-3.5 font-semibold disabled:opacity-70"
            >
              {loading ? (
          ...
          <div className="mt-10 rounded-2xl border border-gray-200 bg-[#F5F9FF] p-6 shadow-omnivyra sm:p-8">
            <div className="flex flex-col items-center">
              ...
              <div className="mt-6 w-full space-y-2 rounded-xl bg-white/80 p-4 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">Conversion path</span>
                  ...
                  {!leadSubmitted ? (
                    <form onSubmit={handleLeadSubmit} className="mt-8 w-full">
                      ...
                      <div className="mt-2 flex gap-2">
                        ...
                        <button
                          type="submit"
                          className="rounded-omnivyra landing-btn-primary px-4 py-2.5 font-semibold"
                        >
                          Save
                        </button>
                      </div>
              ...
              {isAuthenticated && (
                <p className="mt-6 text-sm text-gray-600">Result attached to your account.</p>
              )}
