/** RecommendationsSectionsB — verbatim JSX slice of RecommendationsContent (babel-verified). */
...
export default function RecommendationsSectionsB({ f }: { f: ReturnType<typeof useRecommendationsContentController> }) {
  const {
    d,
