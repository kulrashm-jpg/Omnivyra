...
export const PRIMARY_NAV_ITEMS: PrimaryNavItem[] = [
  ...
  },
  {
    ...
    icon: FileText,
    description: 'Create, review, and manage your content pipeline.',
    matchers: ['/command-center/content', '/blogs', '/stories', '/articles', '/whitepapers', '/case-studies', '/guides', '/newsletters', '/posts', '/threads', '/content-studio', '/content-creation'],
    children: [
      {
        label: 'Create Blog',
        description: 'Start a new blog from the guided creation flow.',
        href: '/blogs/create',
        icon: PenTool,
      },
      {
        label: 'Create Post',
        description: 'Start a new short-form post from the unified post flow.',
        href: '/posts/create',
        icon: Sparkles,
      },
      {
        label: 'View & Manage Content',
        description: 'See everything already created in one place.',
