...
export const CONTENT_NAV_SECTIONS: ContentNavSection[] = [
  {
    ...
    items: [
      ...
      { id: 'story', label: 'Story', route: '/stories/create', description: 'Narrative brand asset' },
      { id: 'article', label: 'Article', route: '/articles/create', description: 'Editorial thought leadership' },
      ...
      { id: 'guide', label: 'Guide', route: '/guides/create', description: 'Evergreen pillar content' },
  ...
  },
  {
    ...
    items: [
      { id: 'image', label: 'Image', route: '/command-center/creator-content/image', description: 'Single-image creative asset' },
      { id: 'carousel', label: 'Carousel', route: '/command-center/creator-content/carousel', description: 'Multi-slide narrative asset' },
      { id: 'banner', label: 'Banner', route: '/command-center/creator-content/banner', description: 'Promotional visual asset' },
      { id: 'infographic', label: 'Infographic', route: '/command-center/creator-content/infographic', description: 'Information-dense explainer' },
      { id: 'pdf', label: 'PDF', route: '/command-center/creator-content/pdf', description: 'Document-style content package' },
      { id: 'slider', label: 'Slider', route: '/command-center/creator-content/slider', description: 'Presentation-style sequence' },
    ],
  },
];
