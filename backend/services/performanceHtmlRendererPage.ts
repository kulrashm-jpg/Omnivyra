/** Part 2/2 of performanceHtmlRenderer.ts — verbatim split (barrel preserved; importers unchanged). */
...
import { type PerformanceRenderMeta, escapeHtml, formatPercent, renderEmptyState, renderSectionHeader, renderRecommendationList, renderTextList, renderMetricNote, renderPriorityBadge, confidenceCopy, renderLeadCommandCenter, renderLeadLeakage, renderConversionsSection, renderBehaviorQuality, renderTopPagesSection, renderOrganicSearchIntelligence, renderDropOffsSection, renderLeadSources } from './performanceHtmlRendererBlocks';
