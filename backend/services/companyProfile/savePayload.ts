...
export function buildSavePayload(
  ...
  return {
    ...
    competitors_list: mergeStringArrays([], input.competitors_list ?? splitToList(input.competitors)),
    ...
    competitors: input.competitors ?? (Array.isArray(input.competitors_list) ? input.competitors_list.join(', ') : null),
