  ...
  linkedin: [
    {
      ...
      formatting_rules: {
        ...
        type_map: { post: 'post', video: 'video', article: 'article', poll: 'post', carousel: 'post' },
      },
      created_at: new Date(0).toISOString(),
    },
    {
  ...
  facebook: [
    {
      ...
      formatting_rules: {
        hashtag_limit: 30,
        suggested_times: ['09:00'],
        type_map: { post: 'post', video: 'video', article: 'post', poll: 'post', carousel: 'post' },
      },
      created_at: new Date(0).toISOString(),
    },
    {
  ...
  youtube: [
    {
      ...
      formatting_rules: {
        ...
        type_map: { post: 'video', video: 'video', article: 'video', poll: 'video', carousel: 'short' },
      },
      created_at: new Date(0).toISOString(),
    },
    {
  ...
  x: [
    {
      ...
      formatting_rules: {
        ...
        type_map: { post: 'tweet', video: 'video', article: 'tweet', poll: 'tweet', carousel: 'tweet' },
      },
      created_at: new Date(0).toISOString(),
    },
    {
