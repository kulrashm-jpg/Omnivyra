/** Part 2/2 of campaignIntelligenceService.ts — verbatim split (barrel preserved; importers unchanged). */
import { normalizePlatform } from '../constants/platforms';
import { randomUUID } from 'crypto';
import { supabase } from '../db/supabaseClient';

import { type CampaignDesignInput, type StrategyContextInput, type CalendarPlanActivityInput, type ExecutionPlanInput, type HealthSuggestionSeverity, type HealthSuggestionCategory, type ActivityRole, type RoleClassificationResult, type LowConfidenceActivity, type RoleDistribution, type HealthSuggestion, type EvaluationScope, type HealthStatus, type CampaignHealthReport } from './campaignIntelligenceServiceModel';
