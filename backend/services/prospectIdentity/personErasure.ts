 ...
 * carried forward. Every such record is returned in
 * `suppressionsLostToErasure`. It is surfaced, not dropped silently, and the
...
function dedupeContactPoints(points: PersonContactPoint[]): PersonContactPoint[] {
