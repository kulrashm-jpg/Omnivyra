import { normalizeCapacityCounts } from '../campaignAiCapacity';
...
function parseContentCapacityToDeliverables(contentCapacity: unknown): PlanDeliverables {
  ...
  if (!text) return { videos: 2, posts: 5, blogs: 1, stories: 0 };
  ...
  if (counters.size === 0) return { videos: 2, posts: 5, blogs: 1, stories: 0 };
