...
export type AuditDecision =
  ...
  | 'elevated_route_accessed'
  | 'elevated_route_denied'
  | 'session_revoked_by_user'
  | 'trusted_device_viewed'
  | 'trusted_device_removed'
  | 'recovery_codes_viewed'
  | 'recovery_codes_regenerated_ui'
  | 'elevated_ui_action_requested'
  | 'elevated_ui_action_completed'
  | 'recovery_regeneration_started'
  | 'recovery_regeneration_completed'
