    ...
    recommendations.length > 0
      ? {
          weeks: recommendations.map((r) => ({
            ...
            phase_label: `Week ${r.week_number}`,
            primary_objective: r.primary_objective ?? '',
            topics_to_cover: r.topics_to_cover ?? [],
            platform_allocation: r.platform_allocation ?? {},
            platform_content_breakdown: r.platform_content_breakdown ?? {},
            content_type_mix: r.content_type_mix ?? [],
            summary: r.summary,
            objectives: r.objectives,
            goals: r.goals,
            suggested_days_to_post: r.suggested_days_to_post,
          })),
        }
      : undefined;
