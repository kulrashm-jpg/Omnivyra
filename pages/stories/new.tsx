...
export default function StoryNewPage() {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `story-${(liveState.title || 'untitled').toLowerCase().replace(/\s+/g, '-')}.md`;
    a.click();
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg bg-pink-600 text-white hover:bg-pink-700 transition-colors disabled:opacity-50"
                    >
                    ...
                    {showUseMenu && (
                      <div className="absolute top-full left-0 mt-1 w-44 bg-white border border-gray-200 rounded-lg shadow-lg z-20 py-1">
                        ...
                        <button onClick={() => handleMarkUsed('social_media')} className="block w-full text-left px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-50">Social Media</button>
                        ...
                        <button onClick={() => handleMarkUsed('email')} className="block w-full text-left px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-50">Email</button>
