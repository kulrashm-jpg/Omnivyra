...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (!secret) {
    console.warn('[cron/campaign-health-monitor] CRON_SECRET not configured; rejecting request to fail closed');
...
export default __createApiRoute(handler, { route: '/api/cron/campaign-health-monitor' });
