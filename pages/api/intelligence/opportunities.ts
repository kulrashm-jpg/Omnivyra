...
import { getOpportunitiesForCompany } from '../../../backend/services/intelligenceOrchestrationService';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const { opportunities } = await getOpportunitiesForCompany(companyId, {
      windowHours,
      buildGraph,
    });
    ...
    console.error('[intelligence/opportunities]', message);
