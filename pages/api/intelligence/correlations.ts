...
import { getCorrelationsForCompany } from '../../../backend/services/intelligenceOrchestrationService';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Failed to fetch correlations';
    console.error('[intelligence/correlations]', message);
