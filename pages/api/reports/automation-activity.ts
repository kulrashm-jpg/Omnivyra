...
function readList(value: unknown): any[] {
  return Array.isArray(value) ? value : [];
}

function getReviewWindowCopy(latestReport: Record<string, any> | null): {
  days: number;
  label: string;
} {
...
function buildAutomationHighlights(params: {
...
function buildAlertHighlights(params: {
...
function buildAutomationPrioritySignal(params: {
...
function buildSnapshotPrioritySignal(params: {
  latestReport: Record<string, any> | null;
}): ScoredHighlight {
