...
import IntelligenceWorkspace from '@/components/dashboard/IntelligenceWorkspace';
...
export default function CMOIntelligenceDashboard() {
  ...
  const requestedIntelTab = getQueryString(router.query.intelTab);
  const isDirectWorkspaceView = requestedIntelTab === 'market-pulse';
  const showIntelligenceOverview = !isDirectWorkspaceView;
  ...
  useEffect(() => {
    if (!companyId || !showIntelligenceOverview) {
      setGuidance(null);
  ...
  }, [companyId, showIntelligenceOverview]);
