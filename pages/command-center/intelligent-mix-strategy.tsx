...
export default function IntelligentMixStrategy() {
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_340px] gap-5">
              <div className="space-y-4">
                <div className="rounded-xl border border-gray-200 p-4 space-y-3 bg-gradient-to-br from-white to-teal-50/40">
                  <div>
