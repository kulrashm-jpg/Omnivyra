    ...
    try {
      ...
      if (output) {
        setPrefillInitial({
          ...
          content_blocks: realizeGeneratedBlocks(output, DEFAULT_TEMPLATE, { contentType: 'guide', documentTitle: output.title }),
          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="flex-1 min-w-0 rounded-lg border border-gray-200 bg-white p-6 shadow">
              ...
              <EditorShareActions
                ...
                exportFileName={`guide-${(liveState?.title || 'pillar').toLowerCase().replace(/\s+/g, '-')}.md`}
