...
import type { Campaign, WeeklyPlan, DailyPlan } from './types';
...
interface Props {
  ...
  toggleWeekExpansion: (weekNumber: number) => void;
  isEnhancingAllWeeks: boolean;
  enhanceAllWeeksWithAI: () => void;
  openTopicWorkspaceFromWeeklyCard: (weekNumber: number, topic: any) => void;
  openCampaignCalendar: (weekNumber?: number, day?: string) => void;
  saveWeekDailyPlan: (weekNumber: number) => Promise<void>;
  viewMode: string;
  onOpenDailyPlanner: () => void;
  expandedSystemWeek: number | null;
  setExpandedSystemWeek: (v: number | null) => void;
  isGeneratingWeek: number | null;
  enhanceWeekWithAI: (weekNumber: number) => Promise<void>;
  regenerateWeekDailyPlan: (weekNumber: number) => Promise<void>;
  isSavingWeekPlan: number | null;
  distributionMode: 'staggered' | 'same_day_per_topic';
  setDistributionMode: (v: 'staggered' | 'same_day_per_topic') => void;
  ...
  handleDailyPlanDragStart: (e: React.DragEvent, planId: string, dayOfWeek: string) => void;
  handleDailyPlanDragOver: (e: React.DragEvent) => void;
  handleDailyPlanDrop: (weekNumber: number, targetDay: string, e: React.DragEvent) => void;
  selectedWeekDay: { weekNumber: number; day: string } | null;
  setSelectedWeekDay: (v: { weekNumber: number; day: string } | null) => void;
}
