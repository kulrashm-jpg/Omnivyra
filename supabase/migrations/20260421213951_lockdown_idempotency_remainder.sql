...
-- Version: 20260421213951  Name: lockdown_idempotency_remainder
-- Idempotency: GUARDED (ADD COLUMN IF NOT EXISTS, CREATE UNIQUE INDEX IF NOT EXISTS, DO blocks).

-- Remainder of 20260420_lockdown_idempotency.sql, with manual_credit_grants
-- statements omitted (table does not exist in this DB).
