...
--
-- Behaviour:
--   OLD.firebase_uid IS NULL  â†’ new value is accepted (initial assignment)
--   OLD.firebase_uid IS NOT NULL, NEW = OLD  â†’ accepted (no-op)
--   OLD.firebase_uid IS NOT NULL, NEW â‰  OLD  â†’ hard error; UPDATE is aborted
--
