...
--
-- Events logged here:
--   user_deleted              â€” account hard/soft-deleted by super-admin
--   role_changed              â€” user's role in a company was changed
--   ghost_session_detected    â€” valid Firebase token with no active DB row
--   unauthorized_access_attempt â€” request blocked by is_deleted or RBAC check
--   domain_validation_failed  â€” COMPANY_ADMIN invite rejected due to wrong domain
