...
export function useSysHealth() {
  ...
  // Drilldown â€” which service card is open
  ...
  // Effect 1: check super_admin_session cookie once on mount (HttpOnly â€” server only)
  useEffect(() => {
  ...
  const fetchData = useCallback(async () => {
    ...
    setError(null);
    try {
      const res  = await apiFetch('/api/super-admin/system-health');
  ...
  const fetchIntelligence = useCallback(async () => {
    ...
    try {
      const res = await apiFetch('/api/super-admin/system-intelligence');
      if (!res.ok) return; // partial failure â€” silently degrade
      const json = await res.json() as IntelligenceData;
      setIntel(json);
    } catch {
      // silently degrade â€” intelligence panel shows "unavailable"
    } finally {
  ...
  // â”€â”€ Filtered anomaly list â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
