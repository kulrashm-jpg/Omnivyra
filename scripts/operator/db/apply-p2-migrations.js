 ...
 * 
 * Usage: node scripts/operator/db/apply-p2-migrations.js
 * 
 * Prerequisites:
...
async function applyMigrations() {
  const safety = enforceOperatorSafety({
    scriptName: 'scripts/operator/db/apply-p2-migrations.js',
    mutationTarget: 'db/schema',
    intendedAction: 'apply P2 database migration statements through the configured Supabase project',
    example: 'node scripts/operator/db/apply-p2-migrations.js --target-env=local --apply',
  });
