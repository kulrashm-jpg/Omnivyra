...
// Agent-B split: text utils + section parser + thin-section expansion live in
// ./editorContentEnforcerShared (behavior-preserving).
import { DECISION_RE, EXAMPLE_RE, EditorEnforcerInput, EditorEnforcerOutput, EnforcerSection, GEO_SUMMARY_CLASS, GEO_SUMMARY_RE, MECHANISM_RE, MIN_INTERNAL_LINKS, MIN_TOKEN_OVERLAP, STOP_WORDS, THIN_SECTION_THRESHOLD, assembleSections, detectAndExpandThinSections, esc, expandSection, parseSections, stripHtml, tokenize } from './editorContentEnforcerShared';
