...
import type { NormalizedValidatorOutputEnvelope } from './normalizedValidatorOutputEnvelope';
import type { ValidatorExecutionEligibilityPolicy } from './validatorExecutionEligibilityPolicy';
import type { ValidatorRuntimeEligibilityInterpretation } from './validatorRuntimeEligibilityInterpreter';
import type { ValidatorRuntimeReadinessEnvelope } from './validatorRuntimeReadinessEnvelope';
import type { ValidatorRuntimeGovernanceEnvelope } from './validatorRuntimeGovernanceEnvelope';
import type { ValidatorRuntimeStabilizationEnvelope } from './validatorRuntimeStabilizationEnvelope';
import type { ValidatorRuntimeActivationReadinessGate } from './validatorRuntimeActivationReadinessGate';
import type { ValidatorRuntimeRolloutClosureEnvelope } from './validatorRuntimeRolloutClosureEnvelope';
...
export interface EditorialDiagnosticReport {
  ...
  validatorRuntimeActivationReadinessGate?: ValidatorRuntimeActivationReadinessGate;
  validatorRuntimeRolloutClosureEnvelope?: ValidatorRuntimeRolloutClosureEnvelope;
}
