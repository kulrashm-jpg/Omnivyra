/** Part of runSprintSheetGeneration (Agent-B split — main module keeps the original path). */
...
export function getSprintSheetTemplate(input: NewsletterGenerationRequest): ContentBlock[] {
...
export function buildSprintSheetPrompt(input: NewsletterGenerationRequest, targetWords: number, retryReason?: string): string {
  const parts: string[] = [];
...
export function buildSprintSheetRepairPrompt(
...
export function buildSprintSheetDepthRepairPrompt(
  input: NewsletterGenerationRequest,
  targetWords: number,
  currentDraft: any,
  retryReason: string,
...
export function buildSprintSheetExpansionPrompt(
  input: NewsletterGenerationRequest,
  targetWords: number,
  currentDraft: any,
  retryReason: string,
...
export function parseSprintSheetOutput(raw: any, template: ContentBlock[]) {
...
export function analyzeSprintSheetDraft(blocks: ContentBlock[]) {
...
export function getSprintSheetComposite(
...
export function mergeSprintSheetRepair(
  baseRaw: any,
  repairRaw: any,
...
export function mergeSprintSheetExpansion(
  baseRaw: any,
  expansionRaw: any,
  template: ContentBlock[],
) {
