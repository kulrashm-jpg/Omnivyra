/** Part of runOperatorPlaybookGeneration (Agent-B split — main module keeps the original path). */
...
export function getOperatorPlaybookTemplate(input: NewsletterGenerationRequest): ContentBlock[] {
...
export function buildOperatorPlaybookPrompt(
...
export function buildOperatorPlaybookRepairPrompt(
  input: NewsletterGenerationRequest,
  targetWords: number,
  currentDraft: any,
  retryReason: string,
...
export function buildOperatorPlaybookDepthRepairPrompt(
  input: NewsletterGenerationRequest,
  targetWords: number,
  currentDraft: any,
  retryReason: string,
...
export function buildOperatorPlaybookExpansionPrompt(
  input: NewsletterGenerationRequest,
  targetWords: number,
  currentDraft: any,
  retryReason: string,
...
export function buildOperatorPlaybookFocusedBodyPrompt(
  input: NewsletterGenerationRequest,
  targetWords: number,
  currentDraft: any,
  retryReason: string,
...
export function parseOperatorPlaybookOutput(raw: any, template: ContentBlock[]) {
...
export function analyzeOperatorPlaybookDraft(blocks: ContentBlock[]) {
...
export function getOperatorPlaybookComposite(
...
export function mergeOperatorPlaybookRepair(
  baseRaw: any,
  repairRaw: any,
...
export function mergeOperatorPlaybookExpansion(
  baseRaw: any,
  expansionRaw: any,
  template: ContentBlock[],
) {
