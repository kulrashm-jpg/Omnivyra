...
export const DEFAULT_INFOGRAPHIC_STYLE: InfographicStyleSchema = {
  ...
  geometry: {
    ...
    denseBody: {
      leadSize: 15, bulletSize: 14, labelSize: 11, valueSize: 13, charWidthFactor: 0.58,
      leadLineHeightMul: 1.5, bulletLineHeightMul: 1.45, panelValueLineHeightMul: 1.35, footerValueLineHeightMul: 1.45,
      ...
      gapAfterStat: 12, gapAfterLead: 11, gapBeforePanels: 13, gapBeforeFooter: 15,
      panelTwoUpMinWidth: 360, panelGap: 12, panelInnerInset: 30, panelLabelY: 20, panelValueStartY: 38,
      panelHeightBase: 28, panelHeightPad: 10,
      footerInnerInset: 34, footerLabelY: 20, footerValueStartY: 38, footerHeightBase: 30, footerHeightPad: 10,
      offsetYCap: 20,
      detail: {
        ...
        panelRx: 10, panelStripeWidth: 5, panelStripeRx: 2, panelOpacity: 0.17, panelTextInset: 18, panelLabelSpacing: 2.2,
        footerRx: 12, footerOpacity: 0.12, footerTextInset: 20, footerLabelSpacing: 2.2,
