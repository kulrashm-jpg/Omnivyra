...
import { sanitizeHTML, verifySanitizedBlock } from '../engine/sanitizer';
...
function assertSanitizedBlock(block: ContentBlock): void {
  if (!verifySanitizedBlock(block)) {
    throw new Error('Unsafe block detected at render time');
  }
}
