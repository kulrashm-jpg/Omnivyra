...
-- Enhanced Daily Activities Table
ALTER TABLE daily_content_plans ADD COLUMN IF NOT EXISTS content_items JSONB DEFAULT '[]';
ALTER TABLE daily_content_plans ADD COLUMN IF NOT EXISTS voice_notes JSONB DEFAULT '[]';
ALTER TABLE daily_content_plans ADD COLUMN IF NOT EXISTS ai_enhanced BOOLEAN DEFAULT FALSE;
ALTER TABLE daily_content_plans ADD COLUMN IF NOT EXISTS content_created BOOLEAN DEFAULT FALSE;

-- Enhanced Weekly Refinements Table
ALTER TABLE weekly_content_refinements ADD COLUMN IF NOT EXISTS voice_notes JSONB DEFAULT '[]';
ALTER TABLE weekly_content_refinements ADD COLUMN IF NOT EXISTS content_items JSONB DEFAULT '[]';
ALTER TABLE weekly_content_refinements ADD COLUMN IF NOT EXISTS ai_enhanced BOOLEAN DEFAULT FALSE;
