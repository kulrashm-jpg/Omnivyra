-- COMPLETE DATABASE RESET AND CLEAN SCHEMA APPLICATION
-- This will drop ALL existing tables and create the clean unified schema
...
-- ==============================================
-- STEP 6: ADD CONSTRAINTS AND VALIDATIONS
-- ==============================================
...
SELECT 'Database schema successfully reset and applied!' as message;
